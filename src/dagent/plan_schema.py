...
"""Typed plan schema for dagent plan/apply flow."""
# ruff: noqa: TC003
...
@dataclass(frozen=True)
class Plan:
    """Serializable plan artifact used by `dagent apply`."""

    version: str
    metadata: PlanMetadata
    api_version: str = "dagent/v1"
    kind: str = "Plan"
    ...
    def from_dict(cls, value: dict[str, Any]) -> Plan:
        ...
        return cls(
            api_version=str(value.get("apiVersion", "dagent/v1")),
